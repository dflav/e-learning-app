  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/quiz/IT1' element={<Test id={1} />} />
        <Route path='/quiz/IT2' element={<Test id={2} />} />
        <Route path='/quiz/IT3' element={<Test id={3} />} />
        <Route path='/quiz/IT4' element={<Test id={4} />} />
        <Route path='/quiz/rev' element={<Test id={5} />} />
