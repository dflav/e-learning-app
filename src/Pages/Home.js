  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles['grid-container']}>
        <Link to={'/e-learning-app/lessons/IT1'} className={styles.card}>
          <span>Διάβασε κάθε κεφάλαιο στην σελίδα των μαθημάτων!</span>

          <img src={book} alt='' />
        </Link>

        <Link to={'/e-learning-app/quiz/IT1'} className={styles.card}>
          <span>Κάνε quiz και δοκίμασε την γνώση σου!</span>

          <img src={quiz} alt='' />
        </Link>
        <Link to={'/e-learning-app/profile'} className={styles.card}>
          <span>Δες τα στατιστικά σου! </span>
          <img src={stats} alt='' />
        </Link>
        <Link to={'/e-learning-app/guide'} className={styles.card}>
